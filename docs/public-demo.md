...
The hosted configuration pins the gateway model ID used in its successful acceptance run. Automatic routing was observed to fail intermittently as other free models exhausted their daily quotas. Pinning removes model-selection drift, but does not guarantee provider uptime or bypass its free quota.
